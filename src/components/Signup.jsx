...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Retrieve pending cart and phone number from location.state or localStorage
      ...
      // Redirect to checkout if coming from checkout and cart/phone exist
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-input-container">
              <input
                ...
                className={error && (!password || password.length < 6) ? 'invalid' : ''}
              />
              <button
                type="button"
